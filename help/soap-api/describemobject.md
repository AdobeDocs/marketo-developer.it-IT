...
feature: SOAP
description: Scopri come utilizzare descriptionMObject in Marketo SOAP per recuperare metadati e attributi di campo per ActivityRecord, LeadRecord, Opportunity e OpportunityPersonRole.
...
Questa funzione restituisce i metadati per oggetti MO standard e virtuali. Accetta l’oggetto Marketo come input e restituisce gli attributi del campo associati a tale oggetto.

## Richiesta

| Nome campo | Obbligatorio/facoltativo | Descrizione |
| --- | --- | --- |
| objectName | Obbligatorio | Il nome dell’oggetto MO per il quale si desidera ottenere i metadati. `objectName` può essere uno dei seguenti: `ActivityRecord`, `LeadRecord`, `Opportunity`, `OpportunityPersonRole` |
