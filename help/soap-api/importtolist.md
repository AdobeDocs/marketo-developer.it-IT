...
title: importToList
feature: SOAP
description: Scopri come utilizzare importToList in Marketo SOAP per importare lead in un elenco statico con intestazioni CSV, sostituzioni di token, esempi XML e controlli dello stato.
