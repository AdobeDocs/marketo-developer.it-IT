...
title: getTags
feature: SOAP, Tags
description: Marketo SOAP getTags recupera tipi di tag e valori non di canale con filtri tag opzionali, oltre a campi di richiesta ed esempi completi di risposta alle richieste XML.
...
Questa funzione recupera le seguenti informazioni sui tag non di canale impostati in Marketo.

- Tipo di tag
- Valore tag

Puoi ottenere informazioni su tutti i tag non di canale o specificare un elenco specifico di tag e/o valori.

## Richiesta

| Nome campo | Obbligatorio/facoltativo | Descrizione |
| --- | --- | --- |
| tagList->tag | Facoltativo | Elenco dei tag sui quali si desidera eseguire una query. Ogni tag può avere un tipo e una matrice di valori come stringhe. Se `<tagList>` viene omesso, riceverai informazioni su tutti i canali |
