...
feature: SOAP
description: Scopri come utilizzare syncMultipleLeads per eseguire l’upsert di più lead Marketo tramite SOAP, chiavi e regole di deduplicazione, limiti di dimensione batch e codice XML, PHP e Java di esempio.
