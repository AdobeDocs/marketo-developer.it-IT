...
feature: SOAP
description: Marketo SOAP deleteMObjects per eliminare Opportunity e OpportunityPersonRole, con XML di richiesta e risposta, esempi di codice che restituiscono DELETED UNCHANGED FAILED.
...
Elimina uno o più [MObjects](marketo-objects.md) e restituisce il risultato dell&#39;operazione (DELETED, UNCHANGED, FAILED).

## Richiesta

| Nome campo | Obbligatorio/facoltativo | Descrizione |
| --- | --- | --- |
| mObjectList->mObject->tipo | Obbligatorio | Può essere uno di `Opportunity` o `OpportunityPersonRole` |
| mObjectList->mObject->id | Obbligatorio | ID dell’oggetto MO da eliminare |
