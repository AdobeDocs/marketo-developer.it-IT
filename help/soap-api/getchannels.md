...
title: getChannels
feature: SOAP
description: Scopri in che modo Marketo SOAP getChannels recupera gli stati di progressione del canale, i numeri dei passaggi e i flag di successo, con esempi XML di richiesta e risposta.
...
Questa funzione recupera le seguenti informazioni su un canale configurato in Marketo:

- Stati di progressione
- Numero di ciascun passaggio di stato progressione
- Se uno stato di progressione specifico è stato definito come successo

Puoi ottenere informazioni su tutti i canali o specificare un elenco specifico di canali

## Richiesta

| Nome campo | Obbligatorio/facoltativo | Descrizione |
| --- | --- | --- |
| tag->valori->stringItem | Facoltativo | Elenco dei canali sui quali si desidera eseguire una query. Se `<tag>` viene omesso, riceverai informazioni su tutti i canali |
