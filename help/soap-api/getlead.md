...
title: getLead
feature: SOAP
description: Utilizza Marketo SOAP getLead per recuperare un singolo lead e tutti i valori dei campi in base a IDNUM, e-mail, cookie o ID SFDC, con un esempio di XML di richiesta e risposta più PHP.
...
Questa funzione recupera un singolo record lead da Marketo, con tutti i valori dei campi incorporati e personalizzati, per un lead identificato dalla chiave fornita (LeadKey). Se il lead esiste in base ai parametri di input, gli attributi del record del lead verranno restituiti nel risultato.

NOTA: gli attributi del lead di tipo stringa e vuoti non verranno restituiti come parte della risposta.
...
| leadKey->keyValue | Obbligatorio | keyValue è il valore in base al quale si desidera eseguire una query sul lead. |
