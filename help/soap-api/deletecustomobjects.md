...
description: Scopri come utilizzare deleteCustomObjects nell’API di Marketo SOAP per eliminare gli oggetti personalizzati in base agli attributi chiave con stati DELETED, UNCHANGED, FAILED e XML, PHP, Java.
...
Elimina uno o più oggetti personalizzati e restituisce il risultato dell&#39;operazione (DELETED, UNCHANGED, FAILED).
...
| customObjKeyLists->elencoChiavi->attributo | Obbligatorio | L’attributo è una coppia chiave/valore utilizzata per identificare gli oggetti personalizzati che desideri eliminare. È possibile specificare più attributi in customObjKeyLists |
