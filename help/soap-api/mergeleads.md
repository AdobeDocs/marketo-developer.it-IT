...
title: mergeLeads
feature: SOAP
description: chiamate SOAP mergeLeads
...
Accetta la chiave di un lead vincente e le chiavi di più lead perdenti per eseguire un’operazione di unione. Restituisce l&#39;ID dei lead e lo stato.

## Richiesta

| Nome campo | Obbligatorio/facoltativo | Descrizione |
| --- | --- | --- |
| winLeadKeyList | Obbligatorio | Chiave utilizzata per identificare il lead vincente. I valori possibili sono: `IDNUM`, `EMAIL`, `SFDCLEADID`, `LEADOWNEREMAIL`, `SFDCACCOUNTID`, `SFDCCONTACTID`, `SFDCLEADID`, `SFDCLEADOWNERID`, `SFDCOPPTYID` |
| losingLeadKeyLists | Obbligatorio | Elenco di chiavi utilizzato per identificare i lead perdenti. |
| mergeInSales | Facoltativo | Passato come booleano, come &quot;True&quot; o &quot;False&quot; |
