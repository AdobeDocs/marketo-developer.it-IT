...
feature: Webhooks
description: Mappature di risposta dei webhook di Marketo per JSON e XML, mappatura degli attributi ai campi lead, notazione in punti e array e compatibilità dei tipi.
...
Marketo può tradurre i dati del webhook da JSON o XML e scrivere i valori nei campi lead. Il parametro Campo Marketo utilizza sempre il nome API SOAP del campo.
